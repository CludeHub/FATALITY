...
function Fatality:ApplyTheme(co)
	if co == "purple" or co == "Purple" then
		-- Your full color table
local colors = {
    ...
    Button = Color3.fromRGB(255, 106, 133),
...
-- Function to update an object’s color safely
...
local function applyColorsRecursively(parent)
    ...
    updateColor(parent) -- apply to parent itself
end

-- Initial application
applyColorsRecursively(fatalityGui)

-- Automatically apply to new descendants
fatalityGui.DescendantAdded:Connect(function(obj)
    updateColor(obj)
end)

-- Watch for property changes and auto-correct
...
-- Watch all existing and future objects
...
function Fatality.new(Window: Window)
	...
	local existingGui = game:GetService("CoreGui"):FindFirstChild("FATALITY")
if existingGui then
    existingGui:Destroy()
		end
