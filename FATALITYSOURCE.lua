...
local Colors = {
	FatalFtame = Color3.fromRGB(19, 19, 19),
	...
	MenuButtonCont = Color3.fromRGB(255, 255, 255),
	...
	SearchFrame = Color3.fromRGB(19, 19, 19),
	SearchBox = Color3.fromRGB(16, 16, 16),
	ScrollingFrame = Color3.fromRGB(255, 255, 255),
	ConfigWindowFrame = Color3.fromRGB(24, 24, 24),
	InputFrame = Color3.fromRGB(16, 16, 16),
	AddConfigButton = Color3.fromRGB(255, 255, 255),
	GetConfigButton = Color3.fromRGB(255, 255, 255),
	SaveConfigButton = Color3.fromRGB(255, 255, 255),
	DeleteButton = Color3.fromRGB(255, 255, 255),
	DropdownItemFrame = Color3.fromRGB(19, 19, 19),
	db_selected = Color3.fromRGB(255, 255, 255),
	ColorPickerFrame = Color3.fromRGB(19, 19, 19),
	ColorPickBox = Color3.fromRGB(39, 255, 35),
	MouseMovement = Color3.fromRGB(255, 255, 255),
	ColorRedGreenBlue = Color3.fromRGB(255, 255, 255),
	ColorRGBSlide = Color3.fromRGB(255, 255, 255),
	Color0pc = Color3.fromRGB(102, 255, 0),
	ColorOptSlide = Color3.fromRGB(255, 255, 255),
	Color0pt = Color3.fromRGB(102, 255, 0),
	PasteButton = Color3.fromRGB(255, 255, 255),
	CopyButton = Color3.fromRGB(255, 255, 255),
	hexCode = Color3.fromRGB(16, 16, 16),
	HexCodeText = Color3.fromRGB(255, 255, 255),
}

function Fatality:ApplyTheme(theme)
if theme == "purple" or theme == "Purple" then
Colors.FatalFrame = Color3.fromRGB(20, 14, 49)
	Colors.DropShadow = Color3.fromRGB(163, 162, 165)
	Colors.Header = Color3.fromRGB(33, 27, 61)
	Colors.HeaderLine = Color3.fromRGB(29, 29, 29)
	Colors.HeaderText = Color3.fromRGB(255, 255, 255)
	Colors.MenuButtonCont = Color3.fromRGB(255, 255, 255)
	Colors.tbc = Color3.fromRGB(255, 255, 255)
	Colors.MenuButton = Color3.fromRGB(43, 37, 71)
	Colors.Icon = Color3.fromRGB(255, 255, 255)
	Colors.menu_name = Color3.fromRGB(255, 255, 255)
	Colors.TextButton = Color3.fromRGB(163, 162, 165)
	Colors.UserProfile = Color3.fromRGB(255, 255, 255)
	Colors.UserIcon = Color3.fromRGB(255, 255, 255)
	Colors.User_name = Color3.fromRGB(255, 255, 255)
	Colors.expire_days = Color3.fromRGB(255, 255, 255)
	Colors.HeaderLineShadow = Color3.fromRGB(0, 0, 0)
	Colors.MenuFrame = Color3.fromRGB(255, 255, 255)
	Colors.MenuLiber = Color3.fromRGB(255, 255, 255)
	Colors.Left = Color3.fromRGB(255, 255, 255)
	Colors.Center = Color3.fromRGB(255, 255, 255)
	Colors.Right = Color3.fromRGB(255, 255, 255)
	Colors.Section = Color3.fromRGB(33, 27, 61)
	Colors.Elements = Color3.fromRGB(23, 17, 51)
	Colors.SpaceBox = Color3.fromRGB(255, 255, 255)
	Colors.Slider = Color3.fromRGB(255, 255, 255)
	Colors.Slider_Name = Color3.fromRGB(255, 255, 255)
	Colors.ValueFrame = Color3.fromRGB(20, 14, 49)
	Colors.OptionButton = Color3.fromRGB(255, 255, 255)
	Colors.boxli = Color3.fromRGB(255, 106, 133)
	Colors.ValueText = Color3.fromRGB(255, 255, 255)
	Colors.Dropdown = Color3.fromRGB(255, 255, 255)
	Colors.Dropdown_Name = Color3.fromRGB(255, 255, 255)
	Colors.icon = Color3.fromRGB(255, 255, 255)
	Colors.Value_Text = Color3.fromRGB(255, 255, 255)
	Colors.Toggle = Color3.fromRGB(255, 255, 255)
	Colors.Toggle_Name = Color3.fromRGB(255, 255, 255)
	Colors.ValueIcon = Color3.fromRGB(255, 255, 255)
	Colors.Button = Color3.fromRGB(20, 14, 49)
	Colors.Button_Name = Color3.fromRGB(255, 255, 255)
	Colors.ColorPicker = Color3.fromRGB(255, 255, 255)
	Colors.ColorPicker_Name = Color3.fromRGB(255, 255, 255)
	Colors.Keybind = Color3.fromRGB(255, 255, 255)
	Colors.Keybind_Name = Color3.fromRGB(255, 255, 255)
	Colors.SectionName = Color3.fromRGB(255, 255, 255)
	Colors.Bottom = Color3.fromRGB(33, 27, 61)
	Colors.HeaderLine_2 = Color3.fromRGB(29, 29, 29)
	Colors.HeaderLineShadow_2 = Color3.fromRGB(0, 0, 0)
	Colors.InfoButton = Color3.fromRGB(255, 255, 255)
	Colors.SearchButton = Color3.fromRGB(255, 255, 255)
	Colors.SaveButton = Color3.fromRGB(255, 255, 255)
	Colors.ConfigButton = Color3.fromRGB(255, 255, 255)
	Colors.Open = Color3.fromRGB(162, 162, 162)
	Colors.SearchFrame = Color3.fromRGB(33, 27, 61)
	Colors.SearchBox = Color3.fromRGB(23, 17, 51)
	Colors.TextBox = Color3.fromRGB(255, 255, 255)
	Colors.ScrollingFrame = Color3.fromRGB(255, 255, 255)
	Colors.ConfigWindowFrame = Color3.fromRGB(33, 27, 61)
	Colors.InputFrame = Color3.fromRGB(23, 17, 51)
	Colors.AddConfigButton = Color3.fromRGB(255, 255, 255)
	Colors.GetConfigButton = Color3.fromRGB(255, 255, 255)
	Colors.SaveConfigButton = Color3.fromRGB(255, 255, 255)
	Colors.DeleteButton = Color3.fromRGB(255, 255, 255)
	Colors.DropdownItemFrame = Color3.fromRGB(20, 14, 49)
	Colors.db_selected = Color3.fromRGB(255, 255, 255)
	Colors.ExtElementFrame = Color3.fromRGB(24, 254, 24)
	Colors.ColorPickerFrame = Color3.fromRGB(20, 14, 49)
	Colors.ColorPickBox = Color3.fromRGB(39, 255, 35)
	Colors.MouseMovement = Color3.fromRGB(255, 255, 255)
	Colors.ColorRedGreenBlue = Color3.fromRGB(255, 255, 255)
	Colors.ColorRGBSlide = Color3.fromRGB(255, 255, 255)
	Colors.Color0pc = Color3.fromRGB(102, 255, 0)
	Colors.ColorOptSlide = Color3.fromRGB(255, 255, 255)
	Colors.Color0pt = Color3.fromRGB(102, 255, 0)
	Colors.PasteButton = Color3.fromRGB(255, 255, 255)
	Colors.CopyButton = Color3.fromRGB(255, 255, 255)
	Colors.hexCode = Color3.fromRGB(20, 14, 49)
	Colors.HexCodeText = Color3.fromRGB(255, 255, 255)
elseif theme == "dark" or theme == "Dark" then
Colors.FatalFtame = Color3.fromRGB(19, 19, 19)
Colors.DropShadow = Color3.fromRGB(163, 162, 165)
Colors.Header = Color3.fromRGB(21, 21, 21)
Colors.HeaderLine = Color3.fromRGB(29, 29, 29)
Colors.HeaderText = Color3.fromRGB(255, 255, 255)
Colors.MenuButtonCont = Color3.fromRGB(255, 255, 255)
Colors.tbc = Color3.fromRGB(255, 255, 255)
Colors.MenuButton = Color3.fromRGB(30, 30, 30)
Colors.Icon = Color3.fromRGB(255, 255, 255)
Colors.menu_name = Color3.fromRGB(255, 255, 255)
Colors.TextButton = Color3.fromRGB(163, 162, 165)
Colors.UserProfile = Color3.fromRGB(255, 255, 255)
...
Colors.MenuLiber = Color3.fromRGB(255, 255, 255)
Colors.Left = Color3.fromRGB(255, 255, 255)
Colors.Section = Color3.fromRGB(19, 19, 19)
Colors.Elements = Color3.fromRGB(24, 24, 24)
Colors.SpaceBox = Color3.fromRGB(255, 255, 255)
Colors.Toggle = Color3.fromRGB(255, 255, 255)
Colors.Toggle_Name = Color3.fromRGB(255, 255, 255)
Colors.ValueFrame = Color3.fromRGB(16, 16, 16)
Colors.ValueIcon = Color3.fromRGB(255, 255, 255)
Colors.OptionButton = Color3.fromRGB(255, 255, 255)
Colors.Slider = Color3.fromRGB(255, 255, 255)
Colors.Slider_Name = Color3.fromRGB(255, 255, 255)
...
Colors.icon = Color3.fromRGB(255, 255, 255)
Colors.Value_Text = Color3.fromRGB(255, 255, 255)
Colors.Button = Color3.fromRGB(16, 16, 16)
Colors.Button_Name = Color3.fromRGB(255, 255, 255)
Colors.ColorPicker = Color3.fromRGB(255, 255, 255)
Colors.ColorPicker_Name = Color3.fromRGB(255, 255, 255)
Colors.SectionName = Color3.fromRGB(255, 255, 255)
Colors.Center = Color3.fromRGB(255, 255, 255)
Colors.Right = Color3.fromRGB(255, 255, 255)
Colors.Bottom = Color3.fromRGB(21, 21, 21)
Colors.HeaderLine_2 = Color3.fromRGB(29, 29, 29)
Colors.HeaderLineShadow_2 = Color3.fromRGB(0, 0, 0)
Colors.InfoButton = Color3.fromRGB(255, 255, 255)
Colors.SearchButton = Color3.fromRGB(255, 255, 255)
...
Colors.ConfigButton = Color3.fromRGB(255, 255, 255)
Colors.Open = Color3.fromRGB(162, 162, 162)
Colors.SearchFrame = Color3.fromRGB(19, 19, 19)
Colors.SearchBox = Color3.fromRGB(16, 16, 16)
Colors.ScrollingFrame = Color3.fromRGB(255, 255, 255)
Colors.ConfigWindowFrame = Color3.fromRGB(24, 24, 24)
Colors.InputFrame = Color3.fromRGB(16, 16, 16)
Colors.AddConfigButton = Color3.fromRGB(255, 255, 255)
Colors.GetConfigButton = Color3.fromRGB(255, 255, 255)
Colors.SaveConfigButton = Color3.fromRGB(255, 255, 255)
Colors.DeleteButton = Color3.fromRGB(255, 255, 255)
Colors.DropdownItemFrame = Color3.fromRGB(19, 19, 19)
Colors.db_selected = Color3.fromRGB(255, 255, 255)
Colors.ColorPickerFrame = Color3.fromRGB(19, 19, 19)
Colors.ColorPickBox = Color3.fromRGB(39, 255, 35)
Colors.MouseMovement = Color3.fromRGB(255, 255, 255)
Colors.ColorRedGreenBlue = Color3.fromRGB(255, 255, 255)
Colors.ColorRGBSlide = Color3.fromRGB(255, 255, 255)
...
Colors.PasteButton = Color3.fromRGB(255, 255, 255)
Colors.CopyButton = Color3.fromRGB(255, 255, 255)
Colors.hexCode = Color3.fromRGB(16, 16, 16)
Colors.HexCodeText = Color3.fromRGB(255, 255, 255)
	end;
...
function Fatality:CreateOption(OptionButton: ImageButton): Elements
	...
	ExtElementFrame.BackgroundColor3 = Colors.ExtElementFrame
...
function Fatality:CreateColorPicker(ColorBox: Frame,Transparency, Callback)
	...
	ColorPickerFrame.BackgroundColor3 = Colors.ColorPickerFrame
	...
	hexCode.BackgroundColor3 = Colors.hexCode
...
function Fatality:CreateDropdown(Parent: Frame, Default: string | {[string]: boolean}, Multiplier: boolean, AutoUpdate: boolean,Callback: (data: any) -> any)
	...
	DropdownItemFrame.BackgroundColor3 = Colors.DropdownItemFrame
...
function Fatality:CreateElements(Parent : Frame , ZIndex : number , Event : BindableEvent,SearchAPI: {Path: string,Memory : (name:string) -> any}) : Elements
	...
	function elements:AddToggle(Config: Toggle)
		...
		ValueFrame.BackgroundColor3 = Colors.ValueFrame
...
function Fatality:CreateConfigWindow(Root: ScreenGui , Fatal , Button: ImageButton)
	...
	ConfigWindowFrame.BackgroundColor3 = Colors.ConfigWindowFrame
	...
	ScrollingFrame.Active = true
	ScrollingFrame.BackgroundColor3 = Colors.ScrollingFrame
	ScrollingFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
	ScrollingFrame.BorderSizePixel = 0
	...
	InputFrame.BackgroundColor3 = Colors.InputFrame
...
function Fatality.new(Window: Window)
	...
	FatalFrame.BackgroundColor3 = Colors.FatalFrame
...
Open_7274.Parent = Fatalitywin
	...
	Bottom.BackgroundColor3 = Colors.Bottom
	...
	HeaderLine_2.BackgroundColor3 = Colors.HeaderLine_2
	...
	function Fatal:AddMenu(Menu : Menu)
		...
		MenuButton.BackgroundColor3 = Colors.MenuButton
		...
		function MenuLib:AddListBox(Config : Listbox)
			...
			ListBox.BackgroundColor3 = Colors.ListBox
			...
			Elements.BackgroundColor3 = Colors.Elements
			...
			SearchBox.BackgroundColor3 = Colors.SearchBox
			...
			TextBox.BackgroundColor3 = Colors.SearchBox
			TextBox.BackgroundTransparency = 1.000
			TextBox.BorderColor3 = Color3.fromRGB(0, 0, 0)
			TextBox.BorderSizePixel = 0
	...
	do
		...
		SearchFrame.BackgroundColor3 = Colors.SearchFrame
